...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`comprobantecompra` (
  `idCompCompra` VARCHAR(10) NOT NULL,
  `idCompra` VARCHAR(10) NOT NULL,
  `codigoComprobante` VARCHAR(50) NOT NULL,
  `tipoComprobante` VARCHAR(50) NOT NULL,
  `fechaEmision` DATE NOT NULL,
  `nombreArchivo` VARCHAR(255) NOT NULL,
  `rutaArchivo` VARCHAR(255) NOT NULL,
  `fechaSubida` DATETIME NULL,
  PRIMARY KEY (`idCompCompra`),
  INDEX `comprobantecompra_ibfk1_idx` (`idCompra` ASC) VISIBLE,
  CONSTRAINT `comprobantecompra_ibfk1`
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`materiaprima` (
  ...
  `unidadMedida` VARCHAR(30) NULL DEFAULT NULL,
  `stockMinimo` INT NULL DEFAULT NULL,
  `tipoMP` VARCHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`materialintermedio` (
  ...
  `stockMinimo` INT NULL DEFAULT NULL,
  `tipoMI` VARCHAR(50) NULL DEFAULT NULL,
  `rutaImagen` VARCHAR(255) NULL,
  `fechaSubida` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`detallecompra` (
  ...
  `tipoElementoComprado` VARCHAR(30) NOT NULL,
  `cantidad` INT NOT NULL,
  `idMateriaPrima` VARCHAR(10) NULL,
  `idMaterialIntermedio` VARCHAR(10) NULL,
  ...
  INDEX `detalleCompra_ibfk_2_idx` (`idMateriaPrima` ASC) VISIBLE,
  INDEX `detalleCompra_ibfk_3_idx` (`idMaterialIntermedio` ASC) VISIBLE,
  ...
  CONSTRAINT `detalleCompra_ibfk_3`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `chk_exclusividad_elemento`
    CHECK (
      (idMateriaPrima IS NOT NULL AND idMaterialIntermedio IS NULL) OR
      (idMateriaPrima IS NULL AND idMaterialIntermedio IS NOT NULL)
    )
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`detallemifabricado` (
  ...
  `gramaje` VARCHAR(50) NULL DEFAULT NULL,
  `textura` VARCHAR(50) NULL DEFAULT NULL,
  `remate` VARCHAR(50) NULL DEFAULT NULL,
  PRIMARY KEY (`idDetalleMIFabricado`),
  INDEX `detallemifabricado_fk_1_idx` (`idMaterialIntermedio` ASC) VISIBLE,
  CONSTRAINT `detallemifabricado_fk_1`
    FOREIGN KEY (`idMaterialIntermedio`)
    REFERENCES `papeleraartesanal`.`materialintermedio` (`idMaterialIntermedio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`venta` (
  ...
  `estadoPago` VARCHAR(30) NULL DEFAULT NULL,
  PRIMARY KEY (`idVenta`),
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`productoterminado` (
  ...
  `stockMinimo` INT NULL DEFAULT NULL,
  `tipoPT` VARCHAR(50) NOT NULL,
  `dimensiones` VARCHAR(50) NULL DEFAULT NULL,
  `idPlantillaMI` VARCHAR(10) NULL,
  `rutaImagen` VARCHAR(255) NULL,
  `fechaSubida` DATETIME NULL,
  PRIMARY KEY (`idProductoTerminado`),
  INDEX `FK1productoterminado_idx` (`idPlantillaMI` ASC) VISIBLE,
  CONSTRAINT `FK1productoterminado`
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`detalleplantillami` (
  ...
  PRIMARY KEY (`idPlantillaMI`, `idMaterialIntermedio`),
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`empleadoxrol` (
  `idEmpleado` VARCHAR(10) NOT NULL,
  `idRol` VARCHAR(10) NOT NULL,
  `fechaRolAñadido` DATETIME NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`inventariomi` (
  ...
  `stockLogico` INT NULL DEFAULT NULL,
  `stockFisico` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`movimientomi` (
  ...
  CONSTRAINT `idInventarioMI`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `movimientomi_ibfk_3`
    FOREIGN KEY (`idCompra`)
    REFERENCES `papeleraartesanal`.`compra` (`idCompra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`movimientomp` (
  ...
  CONSTRAINT `idInventarioMP`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `movimientomp_ibfk_3`
    FOREIGN KEY (`idCompra`)
    REFERENCES `papeleraartesanal`.`compra` (`idCompra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`movimientopt` (
  ...
  `cantidad` INT NULL DEFAULT NULL,
  `idEmpleado` VARCHAR(10) NULL DEFAULT NULL,
  `idInventarioPT` VARCHAR(10) NULL,
...
-- -----------------------------------------------------
-- Table `papeleraartesanal`.`listapedidomi`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `papeleraartesanal`.`listapedidomi` (
  `idMaterialIntermedio` VARCHAR(10) NOT NULL,
  `idPedido` VARCHAR(10) NOT NULL,
  `cantidad` INT NULL,
  `idProductoTerminado` VARCHAR(10) NOT NULL,
  ...
  CONSTRAINT `listapedidomi_ibfk_1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `listapedidomi_ibfk_2`
    FOREIGN KEY (`idMaterialIntermedio`)
    REFERENCES `papeleraartesanal`.`materialintermedio` (`idMaterialIntermedio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `listapedidomi_ibfk_3`
    FOREIGN KEY (`idProductoTerminado`)
    REFERENCES `papeleraartesanal`.`productoterminado` (`idProductoTerminado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
