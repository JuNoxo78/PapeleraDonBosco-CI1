...
INSERT INTO almacen (idAlmacen, nombre, ubicacionFisica) VALUES
...
INSERT INTO docidentidad (idDocIdentidad, tipoDocumento, numeroDocumento) VALUES
('DOC001', 'DNI', '72134465'),
('DOC002', 'Pasaporte', 'AB123456');

-- Llenando la tabla cliente
INSERT INTO cliente (idCliente, idDocIdentidad, nombre, apellido, direccion, telefono, correo, fechaRegistro) VALUES
('CLI001', 'DOC001', 'Juan', 'Pérez', 'Calle Los Olivos 456', '987654321', 'juan.perez@gmail.com', '2025-03-25 10:00:00'),
('CLI002', 'DOC002', 'Ana', 'López', 'Av. Los Rosales 123', '912345678', 'ana.lopez@gmail.com', '2025-03-26 11:00:00');

-- Llenando la tabla proveedor
INSERT INTO proveedor (idProveedor, nombre, ruc, direccion, telefono, activo) VALUES
...
INSERT INTO empleado (idEmpleado, idDocIdentidad, nombre, apellido, direccion, telefono, correo, contraseña, activo, fechaRegistro) VALUES
('EMP001', 'DOC002', 'María', 'Gómez', 'Jr. Los Pinos 321', '987123456', 'maria.gomez@empresa.com', '$2a$10$hashedpassword', 1, '2025-03-25 09:00:00'),
('EMP002', 'DOC001', 'Carlos', 'Ramírez', 'Av. Central 654', '912345679', 'carlos.ramirez@empresa.com', '$2a$10$hashedpassword2', 1, '2025-03-26 10:00:00');

-- Llenando la tabla compra
INSERT INTO compra (idCompra, fechaCompra, totalPagado, estadoCompra, idProveedor, idEmpleado) VALUES
...
INSERT INTO comprobantecompra (idCompCompra, idCompra, codigoComprobante, tipoComprobante, fechaEmision, nombreArchivo, rutaArchivo, fechaSubida) VALUES
...
INSERT INTO comprobantepago (idCompPago, numeroComprobante, tipoComprobante, fechaEmision, montoTotal, nombreArchivo, rutaArchivo, fechaSubida) VALUES
...
INSERT INTO materiaprima (idMateriaPrima, nombre, descripcion, unidadMedida, stockMinimo, tipoMP, rutaImagen, fechaSubida) VALUES
...
INSERT INTO materialintermedio (idMaterialIntermedio, nombre, descripcion, unidad_medida, stockMinimo, tipoMI, rutaImagen, fechaSubida) VALUES
('MI001', 'Papel artesanal A4-001', 'Papel de algodón prensado', 'unidad', 100, 'Fabricado', '/imagenes/mi001.jpg', '2025-03-25 09:00:00'),
...
INSERT INTO detallecompra (idDetalleCompra, idCompra, nombreElemento, tipoElementoComprado, cantidad, idMateriaPrima, idMaterialIntermedio, costoUnitario, costoTotal) VALUES
...
INSERT INTO detallemifabricado (idDetalleMIFabricado, idMaterialIntermedio, dimensiones, gramaje, textura, remate) VALUES
('DMF001', 'MI001', 'A4', '200 g/m²', 'Lisa', 'Bordes rectos'),
('DMF002', 'MI002', 'A3', '300 g/m²', 'Rugosa', 'Bordes biselados');

-- Llenando la tabla venta
INSERT INTO venta (idVenta, idCompPago, fechaVenta, metodoPago, estadoPago) VALUES
('VEN001', 'CP001', '2025-04-02', 'Efectivo', 'Pagado'),
('VEN002', 'CP002', '2025-04-03', 'Tarjeta', 'Pendiente');

-- Llenando la tabla pedido
INSERT INTO pedido (idPedido, idCliente, idEmpleado, observaciones, fechaEntrega, estadoPedido, idVenta, fechaRegistro) VALUES
...
INSERT INTO plantillami (idPlantillaMI, observaciones, cantidadObtenidaPT) VALUES
('PLM001', 'Plantilla para agendas A5', 50),
('PLM002', 'Plantilla para cuadernos A4', 30);

-- Llenando la tabla productoterminado
INSERT INTO productoterminado (idProductoTerminado, nombre, descripcion, precio, stockMinimo, tipoPT, dimensiones, idPlantillaMI, rutaImagen, fechaSubida) VALUES
...
INSERT INTO detallepedido (idPedido, idProductoTerminado, cantidad, precioUnitario) VALUES
('PED001', 'PT001', 10, 25.00),
('PED002', 'PT002', 5, 30.00);

-- Llenando la tabla detalleplantillami
INSERT INTO detalleplantillami (idPlantillaMI, idMaterialIntermedio, cantidadRequerida, comentarios) VALUES
...
INSERT INTO empleadoxrol (idEmpleado, idRol, fechaRolAñadido) VALUES
('EMP001', 'ROL001', '2025-03-25 08:00:00'),
('EMP002', 'ROL002', '2025-03-26 09:00:00');

-- Llenando la tabla inventariomi
INSERT INTO inventariomi (idInventarioMI, idAlmacen, stockLogico, stockFisico, fechaActualizacion, periodo) VALUES
...
INSERT INTO inventariomp (idInventarioMP, idAlmacen, stockLogico, stockFisico, fechaActualizacion, periodo) VALUES
...
INSERT INTO inventariopt (idInventarioPT, idAlmacen, stockLogico, stockFisico, fechaActualizacion, periodo) VALUES
...
INSERT INTO movimientomi (idMovimientoMI, idMaterialIntermedio, fechaMovimiento, tipo, cantidad, idEmpleado, idCompra, idInventarioMI) VALUES
...
INSERT INTO movimientomp (idMovimientoMP, idMateriaPrima, fechaMovimiento, tipo, cantidad, idEmpleado, idCompra, idInventarioMP) VALUES
...
INSERT INTO movimientopt (idMovimientoPT, idProductoTerminado, fechaMovimiento, tipo, cantidad, idEmpleado, idInventarioPT) VALUES
...
INSERT INTO proveedorxmaterialintermedio (idProveedor, idMaterialIntermedio) VALUES
('PROV001', 'MI001'),
('PROV002', 'MI002');

-- Llenando la tabla proveedorxmateriaprima
INSERT INTO proveedorxmateriaprima (idProveedor, idMateriaPrima) VALUES
('PROV001', 'MP001'),
('PROV002', 'MP002');

-- Llenando la tabla listapedidomi
INSERT INTO listapedidomi (idMaterialIntermedio, idPedido, cantidad, idProductoTerminado) VALUES
('MI001', 'PED001', 5, 'PT001'),
('MI002', 'PED002', 3, 'PT002');

-- Llenando la tabla reporte
INSERT INTO reporte (idReporte, tipo_reporte, nombre, fecha_generacion, idEmpleado, filtros_aplicados, descripcion, estado) VALUES
