 ...
 * @author brand
 */
public class Buscar_ClienteVista extends javax.swing.JFrame {

    public Buscar_ClienteVista() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscar_ClienteVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscar_ClienteVista().setVisible(true);
            }
        });
    }
